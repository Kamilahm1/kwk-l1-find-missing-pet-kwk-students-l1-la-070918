...
Next, we have to tell the computer where to move the image. Because we're iide lab root and so is the `elephants` directory, we can just go straight there, and then into `painters`.
